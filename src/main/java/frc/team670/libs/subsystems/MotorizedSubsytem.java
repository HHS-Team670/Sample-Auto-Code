...
public abstract class MotorizedSubsytem implements HealthySubsytem, Subsystem, DebugSubsytem {
  ...
  /**
   * The function `getGearRatio` returns the gear ratio value.
   *
   * @return The method is returning the value of the variable `gearRatio`.
   */
  public double getGearRatio() {
    return gearRatio;
  }

  public abstract Pose3d calculateSimPose();
