...
public class DrivetrainConstants {
    ...
    public static final double driveBaseRadius = Math
            .sqrt(Math.pow(kTrackWidthMeters / 2, 2) + Math.pow(kWheelBaseMeters / 2, 2));

    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.48);

    public static final double MaxSpeed = kSpeedAt12Volts.in(MetersPerSecond); // kSpeedAt12Volts desired top
    // speed
    public static final double MaxAngularRate = RotationsPerSecond.of(1.5).in(RadiansPerSecond); // 3/4 of a rotation
                                                                                                 // per
    // second
    ...
    private static final Distance kFrontLeftXPos = Inches.of(6.215);
    private static final Distance kFrontLeftYPos = Inches.of(6.215);
    ...
    private static final Distance kFrontRightXPos = Inches.of(6.215);
    private static final Distance kFrontRightYPos = Inches.of(-6.215);
    ...
    private static final Distance kBackLeftXPos = Inches.of(-6.215);
    private static final Distance kBackLeftYPos = Inches.of(6.215);
    ...
    private static final Distance kBackRightXPos = Inches.of(-6.215);
    private static final Distance kBackRightYPos = Inches.of(-6.215);
