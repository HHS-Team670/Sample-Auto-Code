...
public class ElevatorConstants {
  ...
  public static final double kCircumferenceSprocket =
      2 * Math.PI * kElevatorSprocketRadius; // .28036
  ...
  public static final float kMaxRotations =
      (float) ((((kMaxExtention - 0.01) / kCircumferenceSprocket) * kGearRatio));
  ;
  ...
  static {
    ...
    leadMotorConfiguration.MotionMagic.MotionMagicCruiseVelocity =
        ElevatorConstants.MotionMagicCruiseVelocity / 60.; // Units:
    // rotations/sec
    leadMotorConfiguration.MotionMagic.MotionMagicAcceleration =
        ElevatorConstants.MotionMagicAcceleration / 60.; // Units:
    // rotations/sec^2
    leadMotorConfiguration.MotionMagic.MotionMagicJerk =
        ElevatorConstants.MotionMagicJerk; // Units:
    // rotations/sec^3
    ...
    // Configure Motion Magic® parameters
    followerMotorConfiguration.MotionMagic.MotionMagicCruiseVelocity =
        ElevatorConstants.MotionMagicCruiseVelocity / 60.; // Units:
    // rotations/sec
    followerMotorConfiguration.MotionMagic.MotionMagicAcceleration =
        ElevatorConstants.MotionMagicAcceleration / 60.; // Units:
    // rotations/sec^2
    followerMotorConfiguration.MotionMagic.MotionMagicJerk =
        ElevatorConstants.MotionMagicJerk; // Units:
    // rotations/sec^3
    followerMotorConfiguration.CurrentLimits.StatorCurrentLimit =
        ElevatorConstants.kStatorCurrentLimit;
