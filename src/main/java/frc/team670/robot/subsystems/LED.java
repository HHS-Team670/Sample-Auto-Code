...
import frc.team670.robot.constants.LEDConstants;
import org.littletonrobotics.junction.Logger;

public class LED implements Subsystem, DebugSubsytem, HealthySubsytem {
    ...
    public LED() {
        ...
        length = LEDConstants.kEndindex - LEDConstants.kStartIndex;
        ...
        setLedMode(Mode.INTAKING_ALGAE);
    }
    ...
    public void setLedMode(LED.Mode status) {
        ...
        switch (status) {
            ...
            case CLIMB:
                ...
                break;
            case CORAL_LEVEL_REQUIRED:
                solidhsv(LEDColor.RED);
                break;
            case CORAL_SIDE_REQUIRED:
                solidhsv(LEDColor.BLUE);
                break;
            case COOPERTITION:
    ...
    public void periodic() {
        ...
        if (isBlinking) {
            blinkCounter++;
            // sets the LED color to the inputted color when the `blinkCounter` is less than
            // or equal to
            // the `blinkEndCount`.
        ...
        // responsible for updating the LED strip with any changes made to the LED
        // buffer.
    ...
    /**
     * The function `solidRainbow` sets the color of each pixel in a LED strip to
     * create a solid
     * rainbow effect.
     *
     * @param isMaxBrightness A boolean value indicating whether the maximum
     *                        brightness should be used
     *                        for the rainbow colors. If true, the brightness value
     *                        will be set to 255. If false, the
     *                        brightness value will be set to 60.
     * @param rainbowPixelHue The `rainbowPixelHue` parameter represents the
     *                        starting hue value for
     *                        the rainbow effect. It determines the color of the
     *                        first pixel in the rainbow sequence.
     */
    ...
    /**
     * The function `animatedRainbow` updates the rainbow animation by incrementing
     * the hue of the
     * first pixel and calling the `solidRainbow` function.
     *
     * @param isMaxBrightness A boolean value indicating whether the rainbow
     *                        animation should be
     *                        displayed at maximum brightness or not.
     * @param updateSpeed     The updateSpeed parameter determines how often the
     *                        rainbow animation should
     *                        be updated. It represents the number of iterations
     *                        before the animation is updated.
     * @param rainbowSpeed    The `rainbowSpeed` parameter determines how quickly
     *                        the colors of the
     *                        rainbow change. A higher value will result in a faster
     *                        movement of the rainbow animation
     *                        while a lower value will result in a slower movement
     *                        of the rainbow animation.
     */
    ...
    /**
     * The function sets the HSV values of each pixel in a LED buffer to create a
     * solid mustang
     * rainbow (white and green) effect with a variable saturation.
     *
     * @param mustangRainbowFirstSaturation The parameter
     *                                      mustangRainbowFirstSaturation represents
     *                                      the
     *                                      initial saturation value for the Mustang
     *                                      Rainbow effect. It determines the
     *                                      starting
     *                                      saturation level for the colors in the
     *                                      rainbow effect.
     */
    public void solidMustangRainbow(int mustangRainbowFirstSaturation) {
        ...
        for (var i = startIndex; i < m_ledBuffer.getLength(); i++) {
            m_ledBuffer.setHSV(
                    i, 60, m_mustangRainbowFirstSaturation + (i * 255 / m_ledBuffer.getLength()) % 255, 255);
        }
        // Check bounds
    ...
    /**
     * The function `animatedMustangRainbow` updates the saturation of a rainbow
     * effect on a Mustang
     * car at a specified speed.
     *
     * @param updateSpeed  The updateSpeed parameter determines how often the
     *                     animation should be
     *                     updated. It represents the number of iterations that need
     *                     to pass before the animation is
     *                     updated.
     * @param rainbowSpeed The rainbowSpeed parameter determines how quickly the
     *                     saturation of the
     *                     rainbow will change
     */
     ...
     *
     * @param index    The index parameter represents the position of the LED in the
     *                 LED buffer. It is
     *                 used to access the LED at the specified index in the buffer.
     * @param newColor The new color that you want to compare with the color of the
     *                 LED at the
     *                 specified index.
    ...
    /**
     * Changes the LED strip so that all the LEDs are one solif color Colors is in
     * HSV FORMAT
     *
    ...
    public static class LEDColor {
        ...
        public static final LEDColor CHEETO_ORANGE = new LEDColor(15);
